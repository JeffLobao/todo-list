...
const Home = () => {
  ...
  const { data: tarefas, isFetched } = userBuscarTarefas();
  ...
  const deletarTarefa = (id) => {
    confirmDialog({
      header: "Alerta:",
      message: "Deseja realmente apagar esses dados?",
      acceptLabel: "Sim",
      reject: "Não",
      accept: () => {
        handleDeletar(id, {
        ...
        <div className="grid">
          {isFetched &&
            tarefas.map((tarefa, index) => (
              <div
                className="col-4 surface-0 border-rounded-md p-3"
                key={index}
              >
